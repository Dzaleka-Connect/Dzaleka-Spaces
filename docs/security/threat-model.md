...
10 July 2026. Re-review after any protected-flag, role, storage, integration or
retention change.
...
| Resend/Supabase/worker secrets                      | Bulk data access, forged email state, queue abuse       |
...
9. Operator workstation -> `DIRECT_URL` migration/test connection.
...
- Hosting, DNS, Supabase and Resend are external availability/security
