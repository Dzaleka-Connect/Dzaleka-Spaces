        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Message the service provider or staff coordinating this repair.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {!workOrder && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Approve a quote from local service providers to begin work.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {pendingQuotes.length === 0 ? (
                  ...
                  <div className="flex flex-col gap-4">
                    {pendingQuotes.map((q) => (
                      <div key={q.id} className="border rounded-md p-4 space-y-3 bg-muted/10">
