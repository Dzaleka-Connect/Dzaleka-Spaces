...
export default async function RequestAssistedListingPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6 px-4 py-8">
      <div>
        <h1 className="text-3xl font-bold">Request an assisted listing</h1>
        <p className="mt-1 text-muted-foreground">
          No smartphone or internet needed. A field representative visits your space, takes
          photographs, writes the description with you and publishes the listing after verification.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card className="py-4">
          <CardHeader>
            ...
            <CardDescription>
              Photographs, description, price and your authority to offer — checked in one visit.
            </CardDescription>
          </CardHeader>
        </Card>
        <Card className="py-4">
