    ...
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-12">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-muted-foreground">
          Short guides to every part of Dzaleka Spaces. For anything else,
          contact support — details at the bottom.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-xl border bg-muted/40 p-6">
        ...
        <p className="flex-1 text-sm text-muted-foreground">
          Still stuck? Support is available by WhatsApp, phone and at the
          Dzaleka Online Services desk.
        </p>
        <Button
          variant="outline"
